    ...
    <div className="flex">
      ...
      <div className="container bg-slate-50 mx-auto p-6">
        ...
        <div className="bg-white shadow-lg p-6 rounded-lg mt-6">
          <h1 className="text-xl font-semibold text-gray-800 mb-4">Gestion des Catégories</h1>
          ...
          <form className="mb-6 flex gap-4" onSubmit={handleAddCategory}>
            <input
              ...
              required
            />
            <button type="submit" className="bg-blue-500 text-white px-4 py-2 rounded hover:blue-600">
              Ajouter
            </button>
          </form>
